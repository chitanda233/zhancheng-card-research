  (func (;60918;) (type 6) (param i32 i32 i32 i32)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
        ...
        block  ;; label = @3
          block  ;; label = @4
            ...
            block  ;; label = @5
              ...
              i32.load offset=28
              i32.const 0
              i32.const 5603 ;; public CancellationToken get_Token() { }
              ...
              local.get 1
              i32.const 0
              i32.const 139106 ;; public CancellationTokenRegistration Register(Action callback) { }
              call_indirect (type 6)
            end
            local.get 3
            i32.const 32
