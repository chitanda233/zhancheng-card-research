  (func (;76970;) (type 10) (param i32 i32 i32 i32 i32 i32)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
    ...
    local.get 2
    i32.const 0
    i32.const 5976 ;; public void .ctor(byte[] data) { }
    call_indirect (type 5)
    i32.const 9820672
    i32.load
    i32.const 357502 ;; 
    ...
    local.get 0
    i32.const 0
    i32.const 5977 ;; public void set_uploadHandler(UploadHandler value) { }
    call_indirect (type 5)
    local.get 5
    local.get 2
    i32.const 0
    ...
    i32.load
    i32.const 0
    i32.const 3800 ;; public void SetRequestHeader(string name, string value) { }
