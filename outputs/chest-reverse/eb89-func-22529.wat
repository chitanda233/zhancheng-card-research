...
i32.const 1
i32.const 0
call 15815 ;; public BattleHexCellState[] GetOpenableHexes(int playerId, bool requireAffordable) { } |
local.set 42
local.get 42
i32.eqz
br_if 0 (;@1;)
...
local.get 3
i32.const 0
call 2472 ;; public BattleConfigPackage Normalize() { } |
i32.const 104
i32.add
i32.const 0
...
local.get 1
i32.const 0
call 9267 ;; public int GetPlayerGold(int playerId) { } |
local.set 2
local.get 7
i32.const 0
...
i32.const 1
i32.const 0
call 6642 ;; public string GetHexOpenBlockReason(int playerId, BattleHexCellState cell, bool requireAffordable) { } |
local.set 8
block  ;; label = @4
local.get 8
if  ;; label = @5
...
local.get 6
i32.const 0
call 16060 ;; public bool IsSoldierHexType(string hexType) { } |
i32.eqz
br_if 0 (;@5;)
i32.const 50
local.set 36
...
local.get 5
local.get 7
call 22531 ;; private static bool CreateFlipCommand(BattleHexCellState target, int commandSeq, out LockstepBattleCommandPayload command) { } |
drop
i32.const 1
local.set 10
end
