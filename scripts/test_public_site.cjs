...
(async () => {
  ...
  try {
    for (const rel of ['index.html','reports/system/index.html','reports/battle/index.html','reports/cards/index.html','reports/journey/index.html','reports/chests/index.html','reports/hex-random/index.html','reports/matching/index.html','reports/matching/bot.html']) {
